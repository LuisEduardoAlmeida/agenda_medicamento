var loa_credito_especial = function() {
  $.ajaxSetup({async: false});
  
  loa_credito_especial_unidade_orcamentaria()
...
function loa_credito_especial_unidade_orcamentaria(){
  $('select.credito_especial_unidade_orcamentaria').off('change')
  $('select.credito_especial_unidade_orcamentaria').change(function() {
    
    var loa_credito_url           = $('.loa_credito_especial').data('url-unorc-det-loa')
    var select_div                = $(this).parents('div').nextAll()
    var select_det_loa            = select_div.find('select.credito_especial_det_loa').first()
  ...
  $('select.credito_especial_det_loa').on('change',function(){
    var select_div                = $(this).parent().parent()
    var select_det_loa            = select_div.find('select[class*="credito_especial_det_loa"]').first()
    var loa_credito_det_loa_hint  = select_div.find('.loa_credito_det_loa_hint').first()
...
$(document).ready(loa_credito_especial)
$(window).bind('page:load', loa_credito_especial)
