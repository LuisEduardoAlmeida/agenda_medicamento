...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { days: @reminder.days, name: @reminder.name, start_at: @reminder.start_at, time: @reminder.time } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { days: @reminder.days, name: @reminder.name, start_at: @reminder.start_at, time: @reminder.time } }
